// Official Model Context Protocol logo — https://github.com/modelcontextprotocol
// Original: black strokes on white bg. Modified: white strokes, no background hexagon.
...
export function MCPLogo({ cx, cy, size = 28 }: MCPLogoProps) {
